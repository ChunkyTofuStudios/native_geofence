...
data class IosGeofenceSettingsWire (
  ...
  val ignoreIfAlreadyInside: Boolean
)
 {
  companion object {
    fun fromList(pigeonVar_list: List<Any?>): IosGeofenceSettingsWire {
      val initialTrigger = pigeonVar_list[0] as Boolean
      val ignoreIfAlreadyInside = pigeonVar_list[1] as Boolean
      return IosGeofenceSettingsWire(initialTrigger, ignoreIfAlreadyInside)
    }
  }
  fun toList(): List<Any?> {
    return listOf(
